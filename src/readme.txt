...
You can embed your WordPress posts in other websites in a similar way you embed social media. Post Embeds plugin enhance the default core post embed functionality by adding customizations and design options.
...
I love feedback! If you have an idea that could improve Post Embeds, please open an issue in [the Github repository](https://github.com/htmgarcia/post-embeds).

##  Bug Reports

Found a bug? Please open an issue with all the details [in the Github repository](https://github.com/htmgarcia/post-embeds).

== Screenshots ==

1. Make your post embeds look like Twitter embeds
2. Make your post embeds look like Facebook embeds
3. Post Embeds plugin is easy to configure!
